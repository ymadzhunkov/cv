...
%   \draw[myblue, fill=myblue] at (3.0, 0.0) rectangle (2.5cm, 3.0cm);
   ...
   \node[draw=none,align=left] at (5.8,1) {\color{white} \Large \textbf{Yordan Madzhunkov} \\ \color{white}Physicist, Software Developer};
   \node[draw=none,align=left] at (14,2) {\color{white} \textbf{"Creativity is intelligence having fun"}\\ \color{white}  \quad \quad \quad \quad \quad \quad \quad \quad Albert Einstein};
\end{tikzpicture}
\end{figure}
\noindent
